...
function CreateGB(_x, _y, _angle, _interval, _xscale, _yscale, _aims) {
	...
	if global.EnemyGroup > 2 || instance_exists(obj_GasterHands_Transition)
		gaster.sprite_index = GasterBlaster92;
	if instance_exists(obj_GasterHands_Transition) {
		gaster.image_blend = c_grey;
		gaster.NoDamage = true;
	}
}